...
const Projects = () => {
  ...
  <a 
    ...
    target="_blank" 
    rel="noopener noreferrer"
    className="flex items-center bg-green-600 hover:bg-green-700 text-white font-medium 
               py-1 px-2 text-xs sm:py-2 sm:px-4 sm:text-base rounded"
  >
    <svg className="w-3.5 h-3.5 mr-1 sm:w-5 sm:h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
